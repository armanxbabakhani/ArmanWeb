        ...
        <body className={styles.container}>
            ...
            <div className={styles.background}>
                <div className={styles.iconwrap}>
                    <Icon_background img="experience_icon.png" className={isClicked ? "clicked" : ""} onClick={()=> setIsClicked(!isClicked)}>
                    ...
                    <a href="https://www.wyzant.com/Tutors/ArmanB">
                        <Icon_background img="/reviews_icon.png" >
                            <Title> Reviews </Title>
                        </Icon_background>
                    </a>
                    <Icon_background img="subjects_icon.png" className={isClicked2 ? "clicked" : ""} onClick={()=> setIsClicked2(!isClicked2)}>
                    ...
                    <a href="https://www.youtube.com/channel/UCtuf8lx4SvE3hEZe7NuagzA">
                        <Icon_background img="videos_icon.png" >
                            <Title> Videos </Title>
                        </Icon_background>
                    </a>
                </div>
